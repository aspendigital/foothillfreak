...
<title>Backcountry skiing Little Superior</title>
<!-- InstanceEndEditable -->
      ...
      <table width="777px" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td valign="top" id="maincontent"><!-- InstanceBeginEditable name="blog window" --> 
              <h1>Little Superior</h1>
			  <img src="DSC01957.jpg" width="600" height="385" alt="Mount Superior South Face" />
                  <p>We skied the south face early, enjoying tasty corn conditions,
                    particulary on the lower apron. Later that afternoon,
                    this massive wet avalanche came down, covering our tracks. </p>
                  <p>&nbsp;</p>
