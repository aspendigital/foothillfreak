    ...
    <td bgcolor="#C5D6E4">
      <table width="777px" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <h1 class="Header">Thaynes Canyon</h1>
            <h6 class="Header">April 9th, 2005</h6>
            <p><span class="location"> </span><span class="location"><br />
              </span><span>Finally got a posse together to explore
              ...
              combined with indecipherable visibility and a ski out finish on
              paper thin snow were some of the highlights, along with skiing
              somewhere completely new that we never got to see. So bad I can't
            wait to go back. </span></p>
            <p><img src="DSC00614.jpg" width="450" height="629" /><br />
              <span>Helm&uuml;t, Princess, and Fu. We were
                later joined by Swindler and some enthusiastic old guy.</span>
            </p>
                    </p>
