    ...
    <td bgcolor="#C5D6E4">
      <table width="777px" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <h1 class="Header">West Porter Gully</h1>
            <h6 class="Header">March 3rd, 2005                  </h6>
            <p><span>Prominent north east gully chute
        between west and main porter fork. Highly visible from Mt. Aire. The
        approach was our first taste of the icy, slippery skin tracks of spring
        this season. Our nerves fried from the unexpected slips that would wake
        us from the otherwise calm climb.</span></p>
            <p><img src="05kumadive.jpg" width="600" height="450" /><br />
                  <span>Supa Boo heads north above West Porter Fork.</span>
            </p>
                  </p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
